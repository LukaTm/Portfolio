...
function Home() {
    ...
    const handleMouseMove = (event) => {
        ...
        const offsetX = (event.clientX - containerCenterX) * 0.04; // Adjust the sensitivity by changing the multiplication value
        const offsetY = (event.clientY - containerCenterY) * 0.05;
        // 4-8 PARTICLES
        const secondOffsetX = (event.clientX - containerCenterX) * 0.02; // Adjust the sensitivity by changing the multiplication value
        const secondOffsetY = (event.clientY - containerCenterY) * 0.02;
    ...
    return (
        <div className="flex flex-col justify-center items-center">
            ...
            <h2>FIND ME ON</h2>
            <div className="particle-outside-wrapper -z-10">
                <div
